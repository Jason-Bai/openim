...
> 让一个真实员工不用读 README，也能把自己的 OpenClaw 助手接进来，并确认它在线、可聊、可恢复、可排查。

日常目标、TODO、验收标准和 agent 分工维护在：

```text
docs/beta-0-openclaw-onboarding.md
```

本文件继续保留历史分阶段任务拆解和人天估算；具体当前优先级以 Beta-0 面板为准。
